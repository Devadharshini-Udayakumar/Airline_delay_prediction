---
title: "ASDS 5303 Final Prroject"
author: "Phuong Trinh, Devadharshini Udayakumar, Yagyesh Jaiswal"
date: "`r Sys.Date()`"
output:
...
# Load Data
```{r}
flights_data <- read.csv("/Users/thienphuong/Downloads/full_data_flightdelay.csv")
head(flights_data)
```
...
accuracy_df
```
The accuracy comparison shows that LDA slightly outperformed QDA, achieving 52.67% compared to QDA’s 49.67%. Although both are close to the 50% threshold (equivalent to guessing), LDA shows marginal improvement and may generalize slightly better for this classification task.
